...
export type SuppressionReason = 'skip' | 'timeout' | 'committee_abstain' | 'cluster_cap' | 'symbol_cap' | 'symbol_cooldown' | 'portfolio_heat' | 'regime' | 'markov_gate' | 'already_held' | 'pending_order' | 'below_min_size' | 'no_running_cohort' | 'outside_cohort_universe' | 'cohort_daily_cap' | 'earnings'
