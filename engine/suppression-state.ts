...
export type SuppressionReason = 'skip' | 'timeout' | 'committee_abstain' | 'cluster_cap' | 'symbol_cap' | 'symbol_cooldown' | 'portfolio_heat' | 'regime' | 'markov_gate' | 'already_held' | 'below_min_size'
