...
import { tryHandleApprovalReply, handleTraderButtonCallback, handleTraderSignalAction } from './telegram-reply-handler.js'
...
describe('handleTraderSignalAction', () => {
  ...
  it('returns null when the latest approval for a signal was already responded', () => {
    insertPendingApproval(db)
    handleTraderButtonCallback(db, 'ap-test-1', 'approve')
