...
export const trainRegimePawConfig: TrainRegimePawConfig = {
  ...
  phases: {
    observe: [
      ...
      '',
      '  cd <trader-engine> && uv run python scripts/train_regime.py --out models/regime_xgb.joblib.new; echo "EXIT_STATUS=$?"',
      '',
    ...
    analyze: [
      ...
      '  cat <trader-engine>/models/regime_xgb.joblib.meta.json',
      '  for the',
